...
<body>
    ...
    <div class="navbar navbar-fixed-top">
      <div class="navbar-inner">
        <div class="container">
          <!-- logo -->
          <a class="brand logo" href="/ari/main.do"><img src="../../../assets/img/logo.jpg" alt=""></a>
          <!-- end logo -->
          <!-- top menu -->
                ...
                <ul>
                  ...
                  <li>
                    <div class="info animate-in">
                      ...
                      <br>
                      <p>
						풍부한 경험과 기술을 통한 합리적인 가격과 최상의 상품을 공급하는 (주)아리가 되겠습니다.
                      </p>
                    </div>
                    <img class="slider_img animate-in" src="../../../assets/img/slides/sequence/mainSlide-1.jpg" alt="">
                  </li>
                  <!-- Layer 2 -->
                  <li>
                    <div class="info">
    ...
    <div class="container">
      <div class="row">
        ...
        <div class="span4">
          <div class="widget">
            <!-- logo -->
            <a class="brand logo" href="/ari/main.do">
							<img src="../../../assets/img/logo.jpg" alt="">
						</a>
            <!-- end logo -->
            <address>
							<strong>Registered Companyname, Inc.</strong><br>
							 경기도 화성시 정남면 서봉로 877<br>
							 Tel: (031) 8055-0860, Fax: (031) 8055-0870
						</address>
          </div>
        </div>
      </div>
