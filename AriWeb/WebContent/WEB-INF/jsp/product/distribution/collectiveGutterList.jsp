		...
		<div class="row">
			<div class="col-md-6 col-md-offset-3">
			    <div class="blogs">
					...
					<hr>
					<!-- 규격 알려주면 div영역 제거예정 (58 ~ 60Line 제거예정)-->
					...
					<div class="slick-div">
						<div id="slick_collectiveGutterSlide">
							<div><img src="../../../../img/product/distribution/collectiveGutter/collectiveGutter1.jpg" alt="" /></div>
							<div><img src="../../../../img/product/distribution/collectiveGutter/collectiveGutter2.jpg" alt="" /></div>
						</div>
					</div>
		...
		<div class="row">
			<div class="col-md-6 col-md-offset-3">
			    <div class="blogs">
					...
					<!-- 규격 알려주면 div영역 제거예정 (85 ~ 88Line 제거예정)-->
					<div style="text-align: center;">
						<img src="../../../../img/contentReadyImg.png" class="img-responsive" style="width:50%;">
					</div>
					<!-- 
