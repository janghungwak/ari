	...
	<div class="productContainer">
			...
			<div class="col-md-6 col-md-offset-3">
			    <div class="blogs">
					<div class="text-center">
						<h2>제품 사진</h2>
						<p>아리에서 생산하는 SUS LOCAL 옥외이중함의 제품사진입니다.</p>
					</div>
					<hr>
					<div class="slick-div">
						<div id="slick_stanGnrCoverSlide">
							<div><img src="../../../../img/product/distribution/susLocalOutdoorDualityBox/susOutdoorLocalDuality1.jpg" alt="" /></div>
							<div><img src="../../../../img/product/distribution/susLocalOutdoorDualityBox/susOutdoorLocalDuality2.jpg" alt="" /></div>
							<div><img src="../../../../img/product/distribution/susLocalOutdoorDualityBox/susOutdoorLocalDuality3.jpg" alt="" /></div>
						</div>
					</div>
		...
		<div class="row">
			<div class="col-md-6 col-md-offset-3">
			    <div class="blogs">
					<div class="text-left">
						<img class="productImg" src="../../../../img/product/distribution/title/susOutdoorLocalDualityTitle.jpg" alt="" />
					</div>
					<div class="text-center">
						<table class="ariTable ariTable-hover">
							...
							<thead>
								<tr>
									...
									<th scope="col" colspan="4" style="text-align: center; vertical-align: middle;">BOX SIZE (mm)</th>
									<th scope="col" rowspan="2" style="text-align: center; vertical-align: middle;">아크릴판 SIZE<br>(WxH)</th>
								...
								<tr>
									...
									<th scope="col" style="text-align: center; vertical-align: middle;">h(지붕)</th>
								</tr>
							</thead>					
							<tbody>
								<tr>
